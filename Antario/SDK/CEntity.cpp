...
mstudiobbox_t* get_hitbox2(C_BaseEntity* entity, int hitbox_index)
{
...
{
	auto hitbox = get_hitbox2(entity, hitbox_id);
	if (!hitbox)
		return Vector(0, 0, 0);
...
bool C_BaseEntity::IsSniper2()
{
	...
	return WeapID == ItemDefinitionIndex::WEAPON_AWP || WeapID == ItemDefinitionIndex::WEAPON_SCAR20 || WeapID == ItemDefinitionIndex::WEAPON_G3SG1;
}
...
bool C_BaseEntity::IsScopableWeapon2()
{
	C_BaseCombatWeapon* pWeapon = (C_BaseCombatWeapon*)this->GetActiveWeapon();
