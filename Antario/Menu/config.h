...
public:
	...
	//triggerbot
	//ButtonCode_t TrigerKey;
	int TriggerBot_Key;
	bool trigger_bot_enable;
	bool trigger_bot_recoil;
	bool trigger_bot_deadmatch;
	bool triget_bot_smokecheck;
	bool trigger_bot_box[5];
	...
	int aimbot_fov = 0;
	int aimbot_resolver = false;

	bool ResolverOverride = false;
	int override_resolver_key = false;

	bool KillCounter = false;
	...
	bool bom_esp_timer = false;
	int yaw_stand = 0;
	int pitch_stand = 0;
	int yaw_move = 0;
	int pitch_move = 0;
	int desync_mode = 0;
	int stand_velocity_threshold = 0;
	int test = 0;
