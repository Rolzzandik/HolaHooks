...
namespace animations {
	...
	//void __fastcall  DoExtraBonesProcessing(void* ECX, void* EDX, void* unkn1, void* unkn2, void* unkn3, void* unkn4, CBoneBitList& unkn5, void* unkn6);
...
struct container_t {
	...
	container_t(C_BaseEntity* ent) {
		...
		m_vmt->hook_method(197, animations::DoExtraBonesProcessing);
		m_vmt->hook_method( 223, animations::UpdateClientSideAnimations);
